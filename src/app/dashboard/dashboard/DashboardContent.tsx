...
import { Plus, TrendingUp, TrendingDown, Target, Download, Settings, Home, Wallet, BarChart3 } from "lucide-react";
            ...
            <AnimatePresence>
              {showExportMenu && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -10 }}
                  className="absolute right-0 top-full mt-1 bg-slate-800 rounded-lg shadow-lg border border-slate-700 z-50"
                >
        ...
        {activeTab === "add" && (
          <div className="p-4">
            <motion.div 
              ...
              className="bg-slate-800/50 rounded-3xl p-6"
            >
              ...
              <form onSubmit={handleAddTransaction} className="space-y-4">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className={`flex-1 py-3 rounded-xl font-medium transition-all ${newTransaction.type === "expense" ? "bg-red-500 text-white" : "bg-slate-700 text-slate-300"}`}
                  >
                    Despesa
                  </button>
                  <button
                    ...
                    className={`flex-1 py-3 rounded-xl font-medium transition-all ${newTransaction.type === "income" ? "bg-green-500 text-white" : "bg-slate-700 text-slate-300"}`}
                  >
                    Receita
                  </button>
                </div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full p-4 bg-slate-700 border-2 border-transparent rounded-xl text-center text-3xl font-bold focus:outline-none focus:border-blue-500"
                    autoFocus
                    required
                  />
                ...
                <button
                  type="submit"
                  className="w-full py-4 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl text-lg transition-all active:scale-95"
                >
                  Guardar
                </button>
              </form>
                  ...
                  return (
                    <div key={goal.id} className={`bg-slate-800/50 rounded-2xl p-4 ${isCompleted ? "border-2 border-green-500" : ""}`}>
                      <div className="flex justify-between items-start mb-2">
                        ...
                        <span className={`text-2xl font-bold ${isCompleted ? "text-green-400" : "text-purple-400"}`}>
